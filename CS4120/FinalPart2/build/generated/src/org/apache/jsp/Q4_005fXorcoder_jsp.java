...
public final class Q4_005fXorcoder_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Q4_XorCoder</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <h1>Xor Coder</h1>\n");
      out.write("        ");
            ...
            if(choice == "Encode") {
                for(int i = 0; i < userIn.length(); i++) {
                    if(!Character.isWhitespace(userIn.charAt(i))) {
                        ...
                        if(i == 0)
                            outMessage.concat(Integer.toString(val));
                        else
                            outMessage.concat(" " + val);
                    }
